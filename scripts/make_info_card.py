...
# ===========================================================================
HOST = "shreyansh"   # shown as  shreyansh@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Web Dev Intern @ InAmigos Foundation"),
    ("kv", "Edu", "B.Tech CSE, VIT Bhopal (Final Yr)"),
    ("kv", "Base", "Bhopal, Madhya Pradesh, India"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "C++, Java, Python, TypeScript"),
    ("kv", "Frontend", "React, Next.js, HTML/CSS"),
    ("kv", "Backend", "Node, Express, NestJS, Django"),
    ("kv", "AI / ML", "PyTorch, TensorFlow, Pandas"),
    ("kv", "Data/Cloud", "MySQL, Redis, Docker, Vercel"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building robust full-stack applications"),
    ("bul", "Researching FinTech optimization models"),
    ("bul", "Designing modern, intuitive UI/UX"),
]
